...
// import Companias from '../paginas/Companias.jsx'
...
export default function Example() {
  const [showCompanias, setShowCompanias] = useState(false);
      ...
      <div className="min-h-full">
                    ...
                    <div className="hidden md:block">
                      <div className="ml-10 flex items-baseline space-x-4">
                        {navigation.map((item) => (
                          <button
                            key={item.name}
                            onClick={() => setShowCompanias(item.name === 'Companies')}
                            className={classNames(
                              item.current
                                ? 'bg-gray-900 text-white'
                                : 'text-black hover:bg-gray-700 hover:text-white',
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            {showCompanias ? <Companias /> : null} {/* Muestra el componente Companias si showCompanias es true */}
          </div>
        </main>
      </div>
    </>
