...
const Busqueda = () => {
    ...
    const { buscador, handleBuscador, empresas} = useEmpresas()

    const empresasFiltradas = busqueda === '' ? [] : empresas.filter(empresa => 
        empresa.nombre.toLowerCase().includes(busqueda.toLocaleLowerCase()) )
